  ...
  <section class="conversation">
    <header class="topbar">
      <div class="topbar-left">
        <button v-if="isMobile" class="icon-button" type="button" @click="emit('open-sidebar')" aria-label="打开会话列表">
          <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
            <path d="M4 6h16a1 1 0 1 1 0 2H4a1 1 0 1 1 0-2Zm0 5h16a1 1 0 1 1 0 2H4a1 1 0 1 1 0-2Zm0 5h16a1 1 0 1 1 0 2H4a1 1 0 1 1 0-2Z" fill="currentColor" />
          </svg>
        </button>
    ...
    <ChatComposer class="composer" @send="emit('send-message', $event)" />
  </section>
</template>
